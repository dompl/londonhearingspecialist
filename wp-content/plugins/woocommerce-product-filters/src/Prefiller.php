...
class Prefiller implements Registerable, JsonSerializable {
		...
		if ( ! empty( $this->parameters ) ) {
			...
			add_action(
				...
				function () use ( $instance ) {
					$instance->process_filters( $instance->parameters );
				},
				10
			);
		}
	 ...
	 *
	 * @param boolean $is_404 whether or not the query is a 404.
	 * @return self
	 */
	public function set_is_404( bool $is_404 ) {
		$this->is_404 = $is_404;
	...
	public function jsonSerialize() {
		$additional_props = Responses::get_additional_shared_json_props();
		...
		return array_merge( $props, $additional_props );
	}
