...
class Filter_Visibility extends Step {
	...
	public function setup_fields() {
		...
		$fields['wcf_options[desktop_visibility]']['value']       = Settings::get_option( 'desktop_visibility', 'open' );
		$fields['wcf_options[mobile_visibility]']['value']        = Settings::get_option( 'mobile_visibility', 'closed' );
		$fields['wcf_options[show_filters_button_text]']['value'] = Settings::get_option( 'show_filters_button_text', __( 'Filter', 'woocommerce-product-filters' ) );
