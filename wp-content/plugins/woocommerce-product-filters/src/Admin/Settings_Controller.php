...
class Settings_Controller implements Registerable {
	...
	public function register_settings() {
		...
		Settings_API_Helper::add_settings_section(
			'wcf_design',
			self::MENU_SLUG,
			__( 'Design', 'woocommerce-product-filters' ),
	...
	public function display_table_design_description() {
		echo '<p>' . esc_html__( 'Customize the design of the filters.', 'woocommerce-product-filters' ) . '</p>';
	}
	...
	public static function get_behavior_settings() {
		return [
			...
			[
				'id'    => 'wcf_options[infinite_scrolling]',
				'title' => __( 'Infinite scrolling', 'woocommerce-product-filters' ),
				'type'  => 'checkbox',
				'label' => __( 'Enable infinite scroll on product listing pages', 'woocommerce-product-filters' ),
			],
			[
				'id'       => 'wcf_options[or_logic]',
				'title'    => __( 'Filter logic', 'woocommerce-product-filters' ),
				'type'     => 'radio',
				'label'    => __( 'Enable "OR" logic', 'woocommerce-product-filters' ),
				'desc_tip' => __( 'Choose between AND or OR logic when selecting from multiple filters. For example, if a customer selects a color and a size then AND logic will only display products which meet both criteria, whereas OR logic will display products which meet either or both criteria.', 'woocommerce-product-filters' ),
				'default'  => 'and',
				'options'  => [
	...
	public static function get_design_settings() {
		return [
			[
				'title'       => __( 'Primary color', 'woocommerce-product-filters' ),
				'type'        => 'color',
				'id'          => 'wcf_options[color_primary]',
				'field_class' => 'custom-design',
				'default'     => '#089ec7',
			],
			[
				'title'       => __( 'Secondary color', 'woocommerce-product-filters' ),
				'type'        => 'color',
				'id'          => 'wcf_options[color_secondary]',
				'field_class' => 'custom-design',
				'default'     => '#E1DFDF',
			],
			[
				'title'             => __( 'Filter title text', 'woocommerce-product-filters' ),
				'type'              => 'color_size',
				'id'                => 'wcf_options[design_filter_title]',
				'custom_attributes' => [
					'min' => 8,
					'max' => 50
				],
