...
namespace Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Schema\Grammars;

use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Schema\Blueprint;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Support\Fluent;
class PostgresGrammar extends Grammar
{
    ...
    {
        return \Barn2\Plugin\WC_Filters\Helpers::collect($blueprint->autoIncrementingStartingValues())->map(function ($value, $column) use($blueprint) {
