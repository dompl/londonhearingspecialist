...
namespace Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Support\Facades;

use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Http\Client\Factory;
/**
 ...
 * @method static \Illuminate\Http\Client\Response \Barn2\Plugin\WC_Filters\Helpers::head(string $url, array|string|null $query = null)
