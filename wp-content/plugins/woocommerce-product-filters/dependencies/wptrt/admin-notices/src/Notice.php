 ...
 */
namespace Barn2\Plugin\WC_Filters\Dependencies\WPTRT\AdminNotices;
...
class Notice
{
     ...
     * @var array
     */
    private $options = ['scope' => 'global', 'type' => 'info', 'alt_style' => \false, 'capability' => 'edit_theme_options', 'option_prefix' => 'wptrt_notice_dismissed', 'screens' => []];
    /**
     ...
     * @var array
     */
    private $allowed_html = ['p' => [], 'a' => ['href' => [], 'rel' => []], 'em' => [], 'strong' => [], 'br' => []];
    /**
     ...
     * @var array
     */
    private $allowed_types = ['info', 'success', 'error', 'warning'];
    /**
     * Constructor.
     *
     * @access public
