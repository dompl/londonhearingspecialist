 ...
 */
namespace Barn2\Plugin\WC_Filters\Dependencies\Carbon\Traits;

use Barn2\Plugin\WC_Filters\Dependencies\Carbon\CarbonInterface;
use Barn2\Plugin\WC_Filters\Dependencies\Carbon\Exceptions\InvalidTypeException;
use Barn2\Plugin\WC_Filters\Dependencies\Carbon\Exceptions\NotLocaleAwareException;
use Barn2\Plugin\WC_Filters\Dependencies\Carbon\Language;
use Barn2\Plugin\WC_Filters\Dependencies\Carbon\Translator;
use Barn2\Plugin\WC_Filters\Dependencies\Carbon\TranslatorStrongTypeInterface;
use Closure;
use Barn2\Plugin\WC_Filters\Dependencies\Symfony\Component\Translation\TranslatorBagInterface;
use Barn2\Plugin\WC_Filters\Dependencies\Symfony\Component\Translation\TranslatorInterface;
use Barn2\Plugin\WC_Filters\Dependencies\Symfony\Contracts\Translation\LocaleAwareInterface;
use Barn2\Plugin\WC_Filters\Dependencies\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
// @codeCoverageIgnoreStart
if (\interface_exists('Barn2\\Plugin\\WC_Filters\\Dependencies\\Barn2\\Plugin\\WC_Filters\\Dependencies\\Symfony\\Contracts\\Translation\\TranslatorInterface') && !\interface_exists('Barn2\\Plugin\\WC_Filters\\Dependencies\\Barn2\\Plugin\\WC_Filters\\Dependencies\\Symfony\\Component\\Translation\\TranslatorInterface')) {
    \class_alias('Barn2\\Plugin\\WC_Filters\\Dependencies\\Barn2\\Plugin\\WC_Filters\\Dependencies\\Symfony\\Contracts\\Translation\\TranslatorInterface', 'Barn2\\Plugin\\WC_Filters\\Dependencies\\Barn2\\Plugin\\WC_Filters\\Dependencies\\Symfony\\Component\\Translation\\TranslatorInterface');
}
