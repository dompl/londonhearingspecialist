...
namespace Barn2\Plugin\WC_Filters\Dependencies\Lib\Admin;

use Barn2\Plugin\WC_Filters\Dependencies\Lib\Plugin\Plugin;
/**
...
class Settings_Util
{
    ...
    public static function get_help_links(Plugin $plugin)
    {
         ...
         * @since 1.1
         */
        $links = \apply_filters('barn2_plugin_settings_help_links', ['doc' => ['url' => $plugin->get_documentation_url(), 'label' => __('Documentation', 'woocommerce-product-filters'), 'target' => '_blank'], 'support' => ['url' => $plugin->get_support_url(), 'label' => __('Support', 'woocommerce-product-filters'), 'target' => '_blank']], $plugin);
