...
function london_footer_navigation_helpers( $key, $name ) {
    ...
    $html = '<div class="wrap">';
    $html .= '<div class="footer-name">' . $name . '</div>';
...
$html .= '<div class="note">';
    $html .= '<p>RAAM Healthcare Limited is registered in England and Wales No 09852381. RAAM Healthcare Limited acts as a credit broker and only offers credit products from Buyline Limited.</p>';
    $html .= '</div>';
