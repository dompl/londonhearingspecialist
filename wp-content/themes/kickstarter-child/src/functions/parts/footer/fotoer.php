...
add_filter( 'london_footer_about', 'london_footer_about_html' );
...
function london_footer_html( $html ) {
    ...
    $html .= '<div class="item about">' . apply_filters( 'london_footer_about', '', ) . '</div>';
    $html .= '<div class="item footer-navigation">';
    $html .= '<div class="top">' . apply_filters( 'london_footer_navigation_top', '', $navs, $themeData ) . '</div>';
    $html .= '<div class="bottom">' . apply_filters( 'london_footer_navigation_bottom', '', $navs, $themeData ) . '</div>';
